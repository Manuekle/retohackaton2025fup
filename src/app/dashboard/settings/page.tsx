...
import { Moon, Sun, User, Bell, Shield, Save, Loader2 } from "lucide-react";
import {
  Form,
  FormControl,
  FormField,
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
          Configura las preferencias de tu cuenta y negocio
        </p>
      </div>
      ...
      <div className="border border-gray-200 dark:border-gray-800 rounded-xl">
        ...
        <div className="p-6 space-y-4">
          <div className="flex items-center justify-between py-3">
            <div>
              <Label className="text-xs font-medium">Notificaciones push</Label>
              <p className="text-xs text-gray-500 dark:text-gray-400">
